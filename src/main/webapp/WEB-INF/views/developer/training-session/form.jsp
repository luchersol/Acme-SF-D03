...
<acme:form>
	...
	<acme:input-moment code="developer.training-session.form.label.timeStart" path="timeStart"/>
	<acme:input-moment code="developer.training-session.form.label.timeEnd" path="timeEnd"/>
